...
// This matches how the core cloud bridge handles these entity types.
...
// Coerce an untrusted value (e.g. a query-string param) to an integer clamped
// to [min, max], falling back to `fallback` when it is not a finite number.
// Used by the admin list endpoints to bound page / page_size safely.

...
const ALEXA_REDIRECT_URI_HOSTS = (
    process.env.ALEXA_REDIRECT_URI_HOSTS || 'layla.amazon.com,pitangui.amazon.com,alexa.amazon.co.jp'
)
    .split(',')
    .map((item) => item.trim().toLowerCase())
    .filter(Boolean);
...
const ALEXA_EVENT_GATEWAY_ENABLED = process.env.ALEXA_EVENT_GATEWAY_ENABLED === '0' ? false : true;
const ALEXA_FORWARDER_SHARED_SECRET = process.env.ALEXA_FORWARDER_SHARED_SECRET || '';
const ALEXA_DEBUG_ENDPOINTS_ENABLED = process.env.ALEXA_DEBUG_ENDPOINTS_ENABLED === '1';
const ALEXA_DEBUG_ADMIN_TOKEN = process.env.ALEXA_DEBUG_ADMIN_TOKEN || '';

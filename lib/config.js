...
// LWA (Login With Amazon) security-profile creds, used to exchange the
// Alexa.Authorization.AcceptGrant code for an Amazon refresh token so we
// can POST proactive events to the Alexa event gateway.
...
const ALEXA_LWA_TOKEN_URL = process.env.ALEXA_LWA_TOKEN_URL || 'https://api.amazon.com/auth/o2/token';
const ALEXA_CHANGE_REPORT_DEBOUNCE_MS = Number(process.env.ALEXA_CHANGE_REPORT_DEBOUNCE_MS || 1200);
const ALEXA_DISCOVERY_DEBOUNCE_MS = Number(process.env.ALEXA_DISCOVERY_DEBOUNCE_MS || 2500);
const ALEXA_PROACTIVE_EVENTS_ENABLED = process.env.ALEXA_PROACTIVE_EVENTS_ENABLED === '0' ? false : true;
const ALEXA_SIGNATURE_VERIFICATION_ENABLED = process.env.ALEXA_SIGNATURE_VERIFICATION_ENABLED === '1';
...
module.exports = {
    ...
    ALEXA_DISCOVERY_DEBOUNCE_MS,
    ALEXA_PROACTIVE_EVENTS_ENABLED,
    ALEXA_SIGNATURE_VERIFICATION_ENABLED,

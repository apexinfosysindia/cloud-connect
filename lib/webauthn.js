    ...
    async function beginRegistration(principal) {
        ...
        const options = await generateRegistrationOptions({
            ...
            authenticatorSelection: {
                ...
                // 'preferred', NOT 'required': Dashlane's biometric flow errors
                // on 'required' across Mac + iOS, while master-password enrolls
                // fine — so requiring UV at request time blocks valid
                // authenticators. Our verifier already uses
                // requireUserVerification:false, so this keeps request + verify
                // consistent and lets biometrics be used when they work.

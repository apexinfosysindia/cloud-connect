...
module.exports = function ({ dbGet, dbRun, config, utils }) {
    ...
    function buildEmailHtml({ heading, body, ctaUrl, ctaLabel, expiryHours, footnote }) {
        ...
        return [
            ...
            '      <!-- Brand header -->',
            '      <tr>',
            '        <td style="background: linear-gradient(135deg, #1d4ed8 0%, #1e3a8a 100%); padding: 32px 32px 28px; text-align: center;">',
            `          <img src="${logoUrl}" alt="Apex Infosys" height="48" style="display: block; margin: 0 auto 12px; width: auto;">`,
            '          <div style="font-family: Inter, -apple-system, BlinkMacSystemFont, \'Segoe UI\', Roboto, sans-serif; font-size: 18px; font-weight: 700; color: #ffffff; letter-spacing: -0.02em;">Oasis Cloud</div>',
            '        </td>',
            '      </tr>',
            '',
            '      <!-- Body -->',

 ...
 * expected after the abandoned-v3 reconciliation in old migration 004. So:
 *
 *   We ADOPT the residue. We do NOT write a new migration to recreate it.
 *   The next numbered migration for any v2 schema *change* will be 003 only
 *   if we first confirm the row (3, 'alexa_integration') is gone, otherwise
 *   it must start at 004 to avoid colliding with the prod-stamped version.
 *
